...
# Load required libraries for biomarker clock analysis
...
# Time and biomarker threshold parameters
year <- 365.25
dx <- 0.001
tip_point <- 4.06
...
# Package parameters for clock creation
...
if (which_data == "KADRC") {
  ...
  df0 <- read.csv(here("data_final",""), header = TRUE)
...
# Create and save clock reference table
...
# Create trajectory plot by chronological age
...
# Create trajectory plot by TIRA time scale
...
# Generate clock intervals table

...
if (which_data == "KADRC") {
  ...
  df0 <- read.csv(here("data_final","KADRC_data_range_1.06_10.45_20250427.csv"), header = TRUE)
  dataset_name <- which_data
} else if (which_data == "ADNI") {
  print("Loading ADNI data")
  df0 <- read.csv(here("data_final","ADNI_data_range_1.06_10.45_20250427.csv"), header = TRUE)
  dataset_name <- which_data
} else {
